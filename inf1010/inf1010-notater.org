...
* Packages, interfaces og tilgangsnivåer
** Packages
...
* Interface
Et interface har kun metodenavn med parametere, ikke kode. Den bestemmer hva metoden skal gjøre, men ikke hvordan. Andre klasser må definere hvordan metoden skal løses, men må følge rollen som interface har gitt.
