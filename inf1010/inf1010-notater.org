...
* TODO Løkker og kontrollstrukturer
...
* DONE Packages, interfaces, tilgangsnivåer og abstract
** Packages
...
#+INCLUDE: "code/generics2.java" src java
dette vil gi en riktig konvertering slik at vi kan hente ut variablene til Person objektet
feks  "tmp.data.navn"
**** Trenger eksempel på comparable.
* DONE Subklasser og polyformi
** Arv
...
* TODO Finalize, garbagecollector etc
...
#+INCLUDE: "code/programeksempler/tradeksempel.java" src java

* TODO Brukergrensesnitt
...
#+END_SRC
* DONE Prinsipper for større programmer
#+BEGIN_SRC
-KISS
    -Moduler
        -Små
...
* TODO Software life cycle and software testing
