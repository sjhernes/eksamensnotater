...
#+INCLUDE: "/github1010/eksamensnotater/inf1010/giteksempler/lenkeeksempel.java" src java
...
#+INCLUDE: "/github1010/eksamensnotater/inf1010/giteksempler/lenkeeksempel2.java" src java

** Innsettingsmetoder
*** LIFO
Innsetting først (LIFO):

#+INCLUDE: "/github1010/eksamensnotater/inf1010/giteksempler//lenkeeksempel3.java" src java
*** FIFO
Innsetting sist (FIFO)
:
#+INCLUDE: "/github1010/eksamensnotater/inf1010/giteksempler//lenkeeksempel4.java" src java

*** Innsetting etter et bestemt objekt

#+INCLUDE: "/github1010/eksamensnotater/inf1010/giteksempler/lenkeeksempel5.java" src java

** Skrive ut en lenket liste

#+INCLUDE: "/github1010/eksamensnotater/inf1010/giteksempler/lenkeeksempel6.java" src java
...
men merk at hvis man skal hente noe ut av personobjektene nå så må vi kontertere(eller caste)
