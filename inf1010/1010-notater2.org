...
#+INCLUDE: "programeksempler/lenkeeksempel.java" src java
...
#+INCLUDE: "programeksempler/lenkeeksempel2.java" src java

** Innsettingsmetoder
*** LIFO
Innsetting først (LIFO):

#+INCLUDE: "programeksempler/lenkeeksempel3.java" src java
*** FIFO
