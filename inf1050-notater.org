...
*** Prosjekttidestimering og aktivitetsnett 
    ...
    *HUSK:*
    ...
    - Historisk sett har vi uansett lav sansynlighet for å treffe

**** Nettverksdiagram(aktivitetsdiagram)
     ...
     - mulige rekkefølger angis som piler mellom to aktiviteter
     - starttidspunkt og ferdigstilling bestemmer diagrammets mulige veier
...
***** Slack
      ...
      - *Positiv slakk* betyr det er tid å gå på, i forhold til sluttdato.
      - *Negativ slakk* betyr at aktiviteten medvirker til at prosjektet ikke blir ferdig tidsnok.
**** Eksempel på aktivitetstabell
    ...
    #+CAPTION: Eksempel på nettdiagram til en aktivitetstabell
    #+LABEL: fig:nettdiag
...
** Delegert vs sentralisert kontrollsti
...
** Generiske systemer
   ...
   *drupal*, *wordpres*, *SAP* og flere er systemer som man utvider med
   egen funksjonalitet/konfigurasjon. Som en applikasjonsarkitekt kan du
   bruke disse generiske systemene på en rekke måter:

   1. Som en grunnplatform å bygge videre på
   2. Som en sjekkliste for å passe på at man har med alt man trenger
   3. Som en måte å organisere arbeid på (man ser på modeller og
      etterligner etter eget behov)
   4. Evaluere komponenter for gjennbruk
   5. Som en måte å finne krav på/sammenligning
...
*** System-testing
    ...
    *For eksempel*:
    - Testing av GUI.
    - Testing av sikkerhet, hastighet, veldlikeholdbarhet og andre ikke-funksjonelle krav.

*** Black box testing
    - Tester systemet, sett fra utsiden, uten kunnskap om koden/system.
    ...
    - Vet ikke hvor store deler av koden som faktisk testes.
    - Kan kontrollere at programmet følger kravspesifikasjoner.
    - Skalerer godt.
    - Man vet ikke hvor feilen oppstår, når man får feil output.
*** White box testing
    - Tester laget av folk med store kunnskaper om koden, 
    ...
    Fordeler ulemper
    - Man er sikker på at alle "kriker" av koden blir testet.
    - Skalerer ikke bra. Antall muligheter øker eksponetielt.
    - Oppdager ikke manglende funksjonalitet.
...
*** Målpris
    ...
    - Fordeler og ulemper
      - Relativ forutsigbar mht. kostnader
...
***** Standardavtale om systemutvikling
***** Standardavtale om systemutviklingsprosjekt
**** Statens standardavtaler (DIFI):
     Laget for å ivareta kunders interesser
***** Programmutviklingsavtalen
...
* Kapittel 11 (Ikke hoved) - Arkitekturdesign
  ...
  *Layered-modellen* organiserer systemet i lag. Kan endres, så lenge interfacet
...
* Kapittel 12 (Ikke hoved) - Distributed system architecture
  ...
  - Kompleksitet.
  - Sikkerhet pga traffiken må gå over nettverk, mulighet for eavsdropping.
  ...
  - *Distribuert objekt-arkitektur*. For objektene er forespørsler 
  ...
  1. Tynn-klient.
     - klienten vil bare mota og sende informasjon, bare ansvarlig for å presentere informasjonen
     - Serveren gjør all prossessering og datamanagement
       
  2. Tykk-klient.
     - Klienten har applikasjonslogikk i tillegg til brukerinteraksjon
     - Serveren har bare ansvar for datamanagement (serveren brukes som database)
