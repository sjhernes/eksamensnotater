...
**** Evolusjonære modeller
     Dette er de modellene vi gjerne bruker i dag, alt ettersom
     hva som passer prosjektet og de som skal bygge systemet.
**** inkrementelle
     Der alle nye krav bygger på et underliggende
     system
**** iterative
**** spiralmodellen
**** XP
...
*** Kjenne til ulike typer utviklingsmetoder og prinsipper
    fordeler og ulemper
**** Modulbasert
     Fordel at det meste er utvliklet i mindre moduler, som er lette å
     teste, og med tanke på gjenbruk 
**** 
